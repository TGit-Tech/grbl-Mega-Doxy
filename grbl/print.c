...
/// \brief  Print a string stored in PGM-memory
...
/// \brief  void printIntegerInBase(unsigned long n, unsigned long base)
// {
...
/// \brief  Debug tool to print free memory in bytes at the called point.
// 
