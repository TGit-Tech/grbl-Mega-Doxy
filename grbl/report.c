...
/// \brief  Internal report utilities to reduce flash with repetitive tasks turned into functions.
...
void report_build_info(char *line)
{
  ...
  serial_write('M');
    ...
    serial_write('A');
  #endif
  #ifndef ENABLE_RESTORE_EEPROM_WIPE_ALL //!< 
/// NOTE:   Shown when disabled.
    serial_write('*');
  #endif
  #ifndef ENABLE_RESTORE_EEPROM_DEFAULT_SETTINGS //!< 
/// NOTE:   Shown when disabled.
    serial_write('$');
  #endif
  #ifndef ENABLE_RESTORE_EEPROM_CLEAR_PARAMETERS //!< 
/// NOTE:   Shown when disabled.
    serial_write('#');
  #endif
  #ifndef ENABLE_BUILD_INFO_WRITE_COMMAND //!< 
/// NOTE:   Shown when disabled.
    serial_write('I');
  #endif
  #ifndef FORCE_BUFFER_SYNC_DURING_EEPROM_WRITE //!< 
/// NOTE:   Shown when disabled.
    serial_write('E');
  #endif
...
/// \brief  Prints the character string line Grbl has received from the user, which has been pre-parsed,
