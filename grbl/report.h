...
#ifndef report_h
#define report_h
/// \brief  Define Grbl status codes. Valid values (0-255)
#define STATUS_OK 0
...
/// \brief  Define Grbl alarm codes. Valid values (1-255). 0 is reserved.
...
/// \brief  Define Grbl feedback message codes. Valid values (0-255).
...
/// \brief  Prints system status messages.
void report_status_message(uint8_t status_code);
/// \brief  Prints system alarm messages.
void report_alarm_message(uint8_t alarm_code);
/// \brief  Prints miscellaneous feedback messages.
void report_feedback_message(uint8_t message_code);
/// \brief  Prints welcome message
void report_init_message();
/// \brief  Prints Grbl help and current global settings
void report_grbl_help();
/// \brief  Prints Grbl global settings
void report_grbl_settings();
/// \brief  Prints an echo of the pre-parsed line received right before execution.
void report_echo_line_received(char *line);
/// \brief  Prints realtime status report
void report_realtime_status();
/// \brief  Prints recorded probe position
void report_probe_parameters();
/// \brief  Prints Grbl NGC parameters (coordinate offsets, probe)
void report_ngc_parameters();
/// \brief  Prints current g-code parser mode state
void report_gcode_modes();
/// \brief  Prints startup line when requested and executed.
void report_startup_line(uint8_t n, char *line);
void report_execute_startup_message(char *line, uint8_t status_code);
/// \brief  Prints build info and user info
