...
/// \brief  Initialize sleep counters and enable timer.
...
/// \brief  Initialization routine for sleep timer.
void sleep_init()
{
...
/// \brief  Increment sleep counter with each timer overflow.
ISR(TIMER3_OVF_vect) { sleep_counter++; }

/// \brief  Starts sleep timer if running conditions are satified. When elaped, sleep mode is executed.
...
/// \brief  Checks running conditions for sleep. If satisfied, enables sleep countdown and executes
