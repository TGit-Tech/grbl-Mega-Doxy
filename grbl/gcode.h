...
/// \brief  Define modal group internal numbers for checking multiple command violations and tracking the
...
/// \brief  #define OTHER_INPUT_F 14
// #define OTHER_INPUT_S 15
// #define OTHER_INPUT_T 16
/// \brief  Define command actions for within execution-type modal groups (motion, stopping, non-modal). Used
...
/// \brief  Modal Group G0: Non-modal actions
...
/// \brief  Modal Group G1: Motion modes
...
/// \brief  Modal Group G5: Feed rate mode
...
/// \brief  Modal Group G6: Units mode
#define UNITS_MODE_MM 0 //!< G21 (Default: Must be zero)
#define UNITS_MODE_INCHES 1 //!< G20 (Do not alter value)
/// \brief  Modal Group G7: Cutter radius compensation mode
#define CUTTER_COMP_DISABLE 0 //!< G40 (Default: Must be zero)
/// \brief  Modal Group G13: Control mode
#define CONTROL_MODE_EXACT_PATH 0 //!< G61 (Default: Must be zero)
/// \brief  Modal Group M7: Spindle control
#define SPINDLE_DISABLE 0 //!< M5 (Default: Must be zero)
#define SPINDLE_ENABLE_CW   PL_COND_FLAG_SPINDLE_CW //!< M3 (
/// NOTE:   Uses planner condition bit flag)
#define SPINDLE_ENABLE_CCW  PL_COND_FLAG_SPINDLE_CCW //!< M4 (
/// NOTE:   Uses planner condition bit flag)
/// \brief  Modal Group M8: Coolant control
#define COOLANT_DISABLE 0 //!< M9 (Default: Must be zero)
#define COOLANT_FLOOD_ENABLE  PL_COND_FLAG_COOLANT_FLOOD //!< M8 (
/// NOTE:   Uses planner condition bit flag)
#define COOLANT_MIST_ENABLE   PL_COND_FLAG_COOLANT_MIST  //!< M7 (
/// NOTE:   Uses planner condition bit flag)
/// \brief  Modal Group G8: Tool length offset
#define TOOL_LENGTH_OFFSET_CANCEL 0 //!< G49 (Default: Must be zero)
#define TOOL_LENGTH_OFFSET_ENABLE_DYNAMIC 1 //!< G43.1
/// \brief  Modal Group G12: Active work coordinate system
// N/A: Stores coordinate system value (54-59) to change to.
/// \brief  Define parameter word mapping.
#define WORD_F  0
#define WORD_I  1
#define WORD_J  2
#define WORD_K  3
...
#define WORD_Y  11
#define WORD_Z  12
/// \brief  Define g-code parser position updating flags
#define GC_UPDATE_POS_TARGET   0 //!< Must be zero
#define GC_UPDATE_POS_SYSTEM   1
#define GC_UPDATE_POS_NONE     2
/// \brief  Define probe cycle exit states and assign proper position updating.
...
#endif
/// \brief  Define gcode parser flags for handling special cases.
...
// uint8_t distance_arc; //!< {G91.1} 
/// NOTE:   Don't track. Only default supported.
  uint8_t plane_select;    //!< {G17,G18,G19}
// uint8_t cutter_comp;  //!< {G40} 
/// NOTE:   Don't track. Only default supported.
...
void gc_init();
/// \brief  Execute one block of rs275/ngc/g-code
uint8_t gc_execute_line(char *line);
/// \brief  Set g-code parser position. Input in steps.
