...
/// \brief  System motion commands must have a line number of zero.
...
/// \brief  Dwell for a specific number of seconds
void mc_dwell(float seconds);
/// \brief  Perform homing cycle to locate machine zero. Requires limit switches.
...
/// \brief  Performs system reset. If in motion state, kills all motion and sets system alarm.
void mc_reset();
