...
/// \brief  Declare gc extern struct
...
/// \brief  Sets g-code parser position in mm. Input in steps. Called by the system abort and hard
...
/// \brief  Executes one line of 0-terminated G-Code. The line is assumed to contain only uppercase
...
// been repeated in the g-code block. If ok, update the command or record its value.
    switch(letter) {
      ...
      /*! \brief 'G' and 'M' Command Words: Parse commands and check for modal group violations.
...
/// NOTE:   All remaining letters assign values.
      default:
        ...
        /*! \brief Non-Command Words: This initial parsing phase only checks for repeats of the remaining
...
//! \todo    An EEPROM read of the coordinate data may require a buffer sync when the cycle
...
// Convert radius value to proper units.
            ...
            /*! \brief  We need to calculate the center of the circle that has the designated radius and passes
...
// Invert the sign of h_x2_div_d if the circle is counter clockwise (see sketch below)
            ...
            /*! \brief The counter clockwise circle lies to the left of the target direction. When offset is positive,
...
//! \todo    Check sync conditions for M3 enabled motions that don't enter the planner. (zero length).
...
//! \todo    % to denote start of program.
