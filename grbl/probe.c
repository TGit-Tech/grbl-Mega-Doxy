...
/// \brief  Inverts the probe pin state depending on user settings and probing cycle mode.
...
/// \brief  Returns the probe pin state. Triggered = true. Called by gcode parser and probe state monitor.
