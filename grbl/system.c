...
/// \brief  Pin change interrupt for pin-out commands, i.e. cycle start, feed hold, and reset. Sets
...
//! \todo    Move this to realtime commands for GUIs to request this data during suspend-state.
          report_gcode_modes();
          break;
