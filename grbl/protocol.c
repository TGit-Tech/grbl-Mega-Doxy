...
#include "grbl.h"
/// \brief  Define line flags. Includes comment type tracking and line overflow detection.
...
// Handles spindle state during hold. 
/// NOTE:   Spindle speed overrides may be altered during hold state.
// 
